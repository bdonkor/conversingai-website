...
const blogPosts = [
  {
    id: 1,
    title: "How AI Agents Are Transforming Customer Service in 2026",
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <main className="container py-16">
        ...
        >
          <motion.h1 variants={itemFadeUp} className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight">
            The <span className="text-blue-500 text-glow">Conversing AI</span> Blog
          </motion.h1>
          <motion.p variants={itemFadeUp} className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
            Insights, strategies, and industry updates on the future of AI-powered business growth.
          </motion.p>

          <motion.div variants={itemFadeUp} className="max-w-xl mx-auto relative group">
        ...
        {featuredPost && (
          ...
          >
            <Link to={featuredPost.slug} className="block">
              <div className="relative group mb-20 overflow-hidden rounded-[32px] border border-white/10 bg-slate-900/40 backdrop-blur-md hover:border-blue-500/30 transition-all cursor-pointer">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                      ...
                      <div>
                        <div className="flex items-center gap-3">
                          ...
                          <a
                            ...
                            className="h-8 w-8 rounded-full bg-blue-600/20 flex items-center justify-center text-blue-400 hover:bg-blue-600 hover:text-white transition-all border border-blue-500/20"
                    ...
                    <div className="inline-flex">
                      <Button className="w-fit bg-blue-600 hover:bg-blue-700 text-white gap-2 px-8 h-12 rounded-full pointer-events-none">
        ...
        >
          {['All', 'AI Strategy', 'Automation', 'SEO', 'Voice AI', 'Ghana AI', 'Case Studies'].map((cat) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 rounded-full border border-white/5 bg-white/5 hover:bg-blue-600/10 hover:border-blue-500/30 transition-all text-sm font-medium"
            >
              {cat}
            </motion.button>
          ))}
        ...
        >
          {regularPosts.map((post) => (
            <motion.div key={post.id} variants={itemFadeUp} whileHover={{ y: -10 }}>
              <Link to={post.slug} className="group flex flex-col bg-white/5 border border-white/10 rounded-3xl overflow-hidden hover:border-blue-500/30 transition-all h-full">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-32 p-12 rounded-[40px] bg-gradient-to-br from-blue-600/20 to-transparent border border-blue-500/20 text-center relative overflow-hidden"
        >
