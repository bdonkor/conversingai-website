        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <motion.h1 variants={itemFadeUp} className="text-4xl md:text-6xl font-extrabold tracking-tight mb-8">
                Ready to <span className="text-blue-500 text-glow">Scale</span> Your Business?
              </motion.h1>
              <motion.p variants={itemFadeUp} className="text-xl text-slate-400 leading-relaxed max-w-lg">
