      ...
      <main>
        ...
        <section className="relative py-20 overflow-hidden border-b border-white/5">
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-purple-600/5 rounded-full blur-[120px] opacity-20" />
          </div>
          ...
          >
            <div className="max-w-3xl">
              ...
              <motion.div variants={itemFadeUp} className="flex flex-wrap gap-4">
                <Link to="/get-quote">
                  <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white gap-2 h-14 px-8 text-lg font-semibold border-2 border-white/40 ring-2 ring-white/10 shadow-lg shadow-blue-900/20">
        ...
        <section className="py-20 bg-slate-950/30">
          ...
          >
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <motion.div variants={itemFadeUp} whileHover={{ y: -5 }} className="text-center group p-6 rounded-2xl hover:bg-white/5 transition-all">
        ...
        <section className="py-20">
          ...
          >
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div variants={itemFadeUp}>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div key={i} variants={itemFadeUp} className="flex items-center gap-3">
              ...
              <motion.div variants={itemFadeUp} className="bg-slate-900 border border-white/10 rounded-3xl relative overflow-hidden h-[450px] shadow-2xl flex flex-col">
